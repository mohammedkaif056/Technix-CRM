    ...
    <footer className="bg-gray-900 text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Company Info */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-indigo-400">Technix-CRM</h3>
            <p className="text-gray-400 mb-4">
              Streamlining customer relationships with powerful, intuitive tools designed for modern businesses.
            </p>
        ...
        <div className="pt-8 border-t border-gray-800 text-center md:flex md:justify-between md:items-center">
          <p className="text-gray-400 mb-4 md:mb-0">
            © {currentYear} Technix-CRM. All rights reserved.
          </p>
